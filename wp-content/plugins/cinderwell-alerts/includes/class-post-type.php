...
class Post_Type {
    ...
    public static function register() {
        register_post_type(
            ...
            [
                'labels' => [
                    'name'                  => __( 'Alert Bars', 'cinderwell-alerts' ),
                    'singular_name'         => __( 'Alert Bar', 'cinderwell-alerts' ),
                    'add_new'               => __( 'Add Alert', 'cinderwell-alerts' ),
                    'add_new_item'          => __( 'Add Alert Bar', 'cinderwell-alerts' ),
                    'edit_item'             => __( 'Edit Alert Bar', 'cinderwell-alerts' ),
                    'new_item'              => __( 'New Alert Bar', 'cinderwell-alerts' ),
                    'view_item'             => __( 'Preview Alert Bar', 'cinderwell-alerts' ),
                    'search_items'          => __( 'Search Alert Bars', 'cinderwell-alerts' ),
                    'not_found'             => __( 'No alert bars found.', 'cinderwell-alerts' ),
                    'item_published'        => __( 'Alert bar published.', 'cinderwell-alerts' ),
                    'item_updated'          => __( 'Alert bar updated.', 'cinderwell-alerts' ),
                    'item_reverted_to_draft'=> __( 'Alert bar reverted to draft.', 'cinderwell-alerts' ),
                ],
                'public'              => false,
